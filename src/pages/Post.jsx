...
import PostImage from '../assets/img/post-sample-image.jpg';
                    ...
                    <div className="row">
                        <div className="col-lg-8 col-md-10 mx-auto">
                            <p>
                                ...
                                — an equal earth which all men occupy as equals. The airman&apos;s
                                earth, if free men make it, will be truly round: a globe in
                                practice, not in theory.
                            </p>

                            <p>
                                Science cuts two ways, of course; its products can be used for both
                                good and evil. But there&apos;s no turning back from science. The
